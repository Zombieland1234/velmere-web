...
out=Path('/tmp/c13-evidence');out.mkdir(parents=True,exist_ok=True)
...
checks=[
 ...
 ('all-current-route-regressions',['node_modules/.bin/tsx','--test',*old_tests,*new_tests,*c12_tests,*c13_tests,'scripts/c11/local-stack.test.ts','scripts/c11/isolated-engine.test.ts','scripts/c11/customer-target.test.ts'],480),
