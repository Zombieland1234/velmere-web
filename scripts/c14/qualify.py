...
out=Path('/tmp/c14-evidence');out.mkdir(parents=True,exist_ok=True)
...
c14_tests=['scripts/c14/origin-dataflow.test.ts']
checks=[
 ('clean-install',['npm','ci','--ignore-scripts','--no-fund'],600),
 ('c14-origin-regressions',['node_modules/.bin/tsx','--test',*c14_tests],240),
 ('c14-test-typescript',['node_modules/.bin/tsc','-p','tsconfig.c14-tests.json','--pretty','false'],480),
 ('c14-origin-before-after',['node','scripts/c14/origin-before-after.mjs',str(out)],180),
 ('c14-compiler-origin-matrix',['node_modules/.bin/tsx','scripts/c14/compiler-origin-matrix.ts',str(out/'compiler')],240),
 ('c14-secret-triage-tests',['python3','scripts/c14/test_secret_triage.py'],60),
 ...
 ('all-current-route-regressions',['node_modules/.bin/tsx','--test',*old_tests,*new_tests,*c12_tests,*c13_tests,*c14_tests,'scripts/c11/local-stack.test.ts','scripts/c11/isolated-engine.test.ts','scripts/c11/customer-target.test.ts'],480),
